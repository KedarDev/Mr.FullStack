...
const Tech = () => {
  return (
    <div className="dark:bg-black laptop:mt-[500px] w-full xs:h-[700px] mt-[300px] mx-auto">
      <motion.div className="relative  dark:xs:mt-[300px] desktop-s:top-[500px] laptop:top-[150px] top-[120px]">
        ...
        <div className="relative selection:inline-flex  justify-center items-center">
          ...
          <img
          className=" hidden dark:block relative laptop:w-[250px] laptop:h-[25px] dark:laptop:ml-[600px] dark:laptop:mt-[-60px] w-[150px] tablet:mt-[-40px] ml-[22em] tablet:ml-[28em] h-[12px] mt-[-25px] "
          ...
          />
          <img
          className=" dark:hidden rotate-[270deg] laptop:ml-[38em] ml-[22em] mt-[-55px]  w-[100px] tablet:w-[120px] laptop:w-[150px] laptop:mt-[-120px] tablet:ml-[460px] tablet:mt-[-80px]"
      ...
      <div
        className=" bg-iPhoneProMax dark:laptop:mt-[120px] dark:mt-[50px] top-[150px] z-[0] p-3 relative h-screen mx-auto  justify-center  bg-contain   bg-no-repeat my-auto  overflow-hidden"
      ...
      >
        ...
        >
          {technologies.map((technology) => (
            ...
            >
              <img
                className="w-[160px] laptop:w-[200px] laptop:mt-10  mt-24"
