  ...
  return (
    <div className="dark:bg-black w-full xs:h-[700px]">
      <motion className="relative desktop-s:top-[500px] laptop:top-[150px] top-[120px]">
        <p
          className={`${styles.sectionSubText} dark:text-white xs:text-[25px] desktop:text-[80px] laptop-l:text-[60px] laptop:text-[50px] tablet:text-[30px]`}
        >
          Full Stack
        </p>
        <div className="relative selection:inline-flex  justify-center items-center">
          ...
          <img
            className="dark:xs:ml-[310px] dark:xs:w-[120px] dark:xs:mt-[-30px] dark:xs:h-3  dark:block sm:hidden sm:w-[60px] sm:h-[8px]  desktop:ml-[10em]  desktop:w-[50em] desktop:h-10 laptop-l:h-7 laptop-l:ml-[80px] laptop-l:w-[600px] relative mobile-m:w-[40%] tablet:w-full 
          ...
          />
                   <img
            className="dark:hidden rotate-[270deg] xs:ml-[330px] xs:mt-[-110px] ml-[10px] w-[100px] h-[130px]"
            src={arrowDark}
            alt="darkarrow"
          />
        </div>
      ...
      <div
        className="bg-iPhoneProMax xs:w-screen xs:ml-[-10px] sm:w-[460px] sm:ml-[-60px] desktop-s:top-[600px] desktop-s:w-[1900px] desktop-s:ml-[50px]  laptop:top-[200px] laptop:h-[800px]  desktop:w-[2600px] laptop-l:w-[1440px] laptop-l:ml-[-24px] laptop:w-[1035px] laptop:ml-[-18px]  top-[150px] 
      ...
      >
        ...
        >
          {technologies.map((technology, index) => (
            ...
            >
              <img
                className="z-50 xs:w-[150px] xs:h-[150px] xs:mt-[130px] sm:w-[120px] sm:h-[120px] sm:mt-[150px]  shrink-0 mobile-m:w-[100px] desktop:w-[600px] desktop:h-[]  laptop-l:w-[350px] mobile-s:w-[80px] mobile-l:w-[120px] 
