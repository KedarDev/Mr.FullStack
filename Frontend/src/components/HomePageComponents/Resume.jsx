  ...
  return (
    ...
    >
      <motion.div variants={textVariant()} className="ml-[30px]">
        ...
        <p className={`${styles.sectionSubText} xs:text-[25px]  dark:text-white  desktop:text-[80px] laptop-l:text-[60px] laptop:text-[50px]`}>Cover Letter</p>
      ...
      <div className=" dark:md:w-[800px] md:w-[800px] dark:xs:w-[450px] xs:mt-[50px] laptop-l:ml-[10px] laptop:w-[1030px] laptop:ml-[2px] mobile-m:w-[385px]  mobile-m:ml-[-3.5px] mobile-l:ml-[-3px]  mobile-s:w-[335px] mobile-l:w-[425px] relative flex-1 justify-center items-center min-h-screen bg-hero bg-center">
        <img
          src={Macbook}
          alt="macbook"
        ...
        <div className="desktop:ml-[60px] desktop:w-full mobile-m:w-[390px] desktop:mt-[-100em] laptop-l:mt-[-900px]  laptop:mt-[-650px] mobile-s:w-[140px] mobile-s:ml-[105px] mobile-s:mt-[-210px] mobile-m:mt-[-235px] mobile-l:mt-[-255px] tablet:mt-[-455px] relative mt-[-78%] flex-1 flex justify-center items-center xl:min-h-screen max-xl:py-40 bg-primary bg-cover bg-center">
          <img
            ...
            width={430}
            height={200}
            className=" md:w-[320px] md:mt-[130px] xs:w-[180px] xs:mt-[60px] desktop-s:w-[850px] desktop-s:mt-[-400px] desktop:w-[1200px] desktop:h-[1300px] laptop-l:w-[600px] mobile-s:w-[150px] mobile-m:w-[150px] mobile-l:w-[160px] tablet:w-[300px] object-contain relative z-10"
          />
        </div>
        <div className=" md:w-screen md:ml-[10px] xs:w-full xs:ml-[10px] dark:bg-black desktop-s:mt-[20em] desktop:mt-[40em]   tablet:mt-[150px] laptop:mt-[300px] mobile-s:absoulte  flex sm:gap-6 gap-4 absoulte bottom-[5%]  mt-[100px] justify-center items-center content-center   max-sm:px-6 ">
          {resumes.map((resume) => (
            <div className="md:mt-[80px] md:w-screen desktop:ml-[100px] desktop-s:w-full desktop:w-full desktop:h-[400px] laptop-l:mt-[150px] laptop:mt-[50px] tablet:w-[20%] mobile-s:w-[20%] mobile-m:w-[20%] " key={resume}>
              <ResumeCard
                imgURL={resume}
                changeBigResumeImage={(resume) => setBigResumeImg(resume)}
                bigResumeImg={resume}
              />
              <h1 className="md:text-[20px] xs:text-[14px]  mobile-s:text-black dark:text-white xs:text-[#FF0000]  desktop-s:text-[45px] laptop-l:mt-[30px] laptop-l:p-5  laptop:p-5 tablet:mt-[20px] flex mx-auto py-auto justify-center items-center  mobile-s:text-[10px] mobile-m:text-[10px] mobile-l:text-[12px] laptop:text-[35px] laptop-l:text-[35px]  desktop:text-[60px] text-[25px]">
                {resume.name}
              </h1>
            </div>
          ))}
