...
const Works = () => {
        ...
        >
          <div className="  xs:w-[180px] xs:h-[120px] xs:mt-[-620px] desktop-s:mt-[-1100px] desktop-s:h-[600px] desktop:h-[800px] desktop:w-[800px] laptop-l:h-[400px] relative w-full mobile-s:p-1 mobile-m:p-1 mobile-s:w-[130px] mobile-m:w-[200px] mobile-l:w-[200px] mobile-l:h-[110px] tablet:w-[300px]  mobile-m:h-[110px] mobile-s:h-[100px] h-[280px]">
            ...
            <div className="mt-5 w-full xs:mt-0 mobile-s:m-0   mobile-m:m-0 mobile-s:mt-[10px] mobile-m:mt-[-10px]  mobile-s:w-full">
              <h3 className="xs:text-[18px]  text-white font-bold mobile-s:text-[10px] mobile-m:mt-[20px] mobile-l:mt-[-18px] laptop:text-[30px] laptop-l:text-[30px] desktop:text-[80px]
              mobile-m:text-[12px] mobile-l:text-[12px] tablet:mt-[-18px] tablet:text-[20px] text-[24px]">{name}</h3>
              <p className="xs:text-[10px]  mobile-s:text-[8px] mobile-m:text-[11px]  mobile-l:text-[11px] mobile-m:mt-[-1px] laptop:text-[25px] laptop-l:text-[30px]
            ...
            <div className="xs:mt-0  mt-4 mobile-s:mt-[-1px] mobile-l:mt-[-1px] flex flex-wrap gap-1 mobile-s:gap-1">
              {tags.map((tag) => (
                <p key={tag.name} className={` xs:text-[9px] desktop:text-[40px] laptop-l:text-[25px] tablet:mt-[-10px] tablet:text-[12px]  mobile-m:mt-[-10px] mobile-s:text-[6px] 
  ...
  return (
    <>
      <motion.div className="xs:mt-[200px]  relative sm:mt-[-500px] desktop-s:mt-[-600px] laptop:ml-[10px] w-full mobile-s:mt-[-400px] mobile-m:mt-[-400px] mobile-l:mt-[-400px] tablet:mt-[-400px] laptop:mt-[300px]">
      ...
      <div ></div>
      <div className=" bg-iPad sm:w-[460px] xs:ml-[-10px] xs:w-screen sm:ml-[-65px] dark:bg-black desktop-s:w-[2045px] desktop:w-[2640px] desktop:ml-[-14px] laptop-l:w-[1440px] laptop-l:ml-[-25px] laptop:mt-[40px] laptop:w-[1040px] laptop:ml-[-25px] mobile-m:w-[394px] mobile-l:w-[425px] mobile-l:ml-[-25px] 
