...
const Hero = () => {
  return (
    <section className=" mobile-s:w-[100%]sticky w-full h-screen mx-auto">
      <div
        className={`${styles.paddingX} absolute top-[120px] max-w-7x1 mx-auto flex flex-row items-start gap-5`}
      >
        <div className="flex flex-col justify-center items-center mt-5">
          <div className=" mobile-s:w-fit w-5 h-5 rounded-full bg-black" />
          <div className=" w-1 sm:h-80 h-40 black-gradient " />
        </div>
        <div>
          <h1 className={`${styles.heroHeadText} text-black`}>
            Hi, I'm <span className="text-black">MrFullStack</span>
          </h1>
