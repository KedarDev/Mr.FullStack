...
const Hero = () => {
  return (
    ...
    >
      <video
        className="block tablet:ml-[-13px] dark:mobile:h-auto mobile:ml-[-6px] mobile:mt-[200px]  w-screen border-none pt-[130px] desktop:pt-[0px] desktop:ml-[26px]"
          ...
          <div className=" mt-[80px] mobile-s:w-full  w-[90%] h-[64px] rounded-3xl  flex justify-center items-start p-2 ">
            ...
            >
              <img
                src={arrowDark} 
                alt=""
                className="mobile-s:mt-[500px] tablet:mt-[340px] tablet:ml-[-12px]  mobile:h-[80px] mobile:w-fit   mobile-s:ml-[-2px]  w-10 ml-[62px] mt-[-50px] desktop:mt-[0px] desktop:ml-[48px] laptop:w-16 laptop:h-[80px] laptop:mt-[100px] laptop:ml-[92px] "
              ...
              <img
                src={arrow}
                alt=""
                className=" dark:tablet:ml-[-0px] mobile:h-[80px] mobile:w-fit dark:mobile:mt-[-80px] dark:mobile:ml-[16px]  mobile-s:ml-[16px] mobile-s:mt-[-30px] laptop:h-16 laptop:w-[25px] laptop:ml-[116px] laptop:mt-[-80px] hidden dark:block w-[12px] shadow-2xl drop-shadow-2xl h-[30px] ml-[75px]"
