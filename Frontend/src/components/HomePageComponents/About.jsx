  ...
  return (
    <>
      ...
      <motion.p
        ...
        className=" mobile:mt-[60px] mobile:text-[25px] mobile:ml-[0px] mobile-s:ml-[-10px] mobile-s:w-screen desktop:ml-[100px] desktop:text-[30px]  laptop:mt-[200px] tablet:text-[20px] laptop:text-[28px]  grid text-center mt-10 leading-[30px] dark:text-white"
      ...
      <div 
      className=" mobile:mt-[100px] mobile:ml-[14px] mobile-s:mt-[100px] mobile-s:ml-[12px] desktop:ml-[58px] laptop:mt-[200px] w-full tablet:w-fit tablet:ml-[134px] laptop:ml-[-12px] dark:laptop:ml-[-12px] grid tablet:grid-cols-2 laptop:grid-cols-4  items-center align-middle justify-center content-center place-content-center pt-40 gap-20 tablet:justify-center tablet:items-center "
