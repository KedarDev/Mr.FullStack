...
const ScrollToTop = () => {
  return (
<div
className="dark:bg-black absolute  w-full flex justify-center items-center"
...
<a href="#hero" className="">
  <div
  className="dark:bg-black h-[64px] rounded-3xl flex justify-center items-start p-2 "
