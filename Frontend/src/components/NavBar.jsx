        ...
        <div>
          ...
          >
            ...
            >
              ...
              <li className="">
                <img
                className=" mobile-s:hidden ml-[-80px] mt-[-18px] laptop:mt-[-24px] justify-center align-middle items-center w-[180px] h-[12px] laptop:ml-[-180px] laptop:h-[18px] laptop:w-[400px] " src={MFLogo}  
