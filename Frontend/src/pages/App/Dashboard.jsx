...
import { getOthersFeedsApi } from "../../utils/ApiUtils";
...
const Dashboard = () => {
  ...
  useEffect(() => {
    document.title = "Dashboard | Portfolio APP";
    getOthersFeeds(0);
  }, []);
  ...
  return (
    <main className=" desktop-s:max-w-[90%] black-gradient grid grid-cols-1 lg:grid-cols-2 gap-6 my-12 mx-0 md:mx-12 w-2xl container px-2 mx-auto">
      {/* {#MyProfile Component} */}
      <MyProfile />
      <article>
        {/* {#AddFeed Component} */}
