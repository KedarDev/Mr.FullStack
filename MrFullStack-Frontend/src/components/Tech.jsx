  ...
  return (
    <>
      <motion className="relative top-[120px]">
        <p className={`${styles.sectionSubText} laptop-l:text-[60px] laptop:text-[50px] tablet:text-[30px]`}>Full Stack</p>
        <div className="inline-flex  justify-center items-center">
          <h2 className={`${styles.sectionHeadText} laptop-l:text-[70px] text-[30px] laptop:text-[70px] tablet:text-[50px] pl- mx-auto`}>
            Technologies
          </h2>
          <img
