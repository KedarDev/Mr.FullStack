  ...
  return (
    <>
      <motion className="relative top-[120px]">
        <p className={`${styles.sectionSubText} tablet:text-[30px]  `}>Full Stack</p>
        <div className="inline-flex  justify-center items-center">
          <h2 className={`${styles.sectionHeadText} text-[30px] tablet:text-[50px] pl- mx-auto`}>
            Technologies
          </h2>
          <img
            className=" relative mobile-m:w-[40%] tablet:w-full mobile-m:h-3 tablet:ml-[30px] mobile-l:h-3  mobile-s:w-[25%]  mobile-s:h-2 w-[45%] ml-2 h-5 justify-center items-center content-center "
            src={WhiteArrow}
            alt="whitearrow"
          />
        </div>
      ...
      <div className="iPhone15 top-[150px] mobile-l:w-[425px] tablet:w-[768px] mobile-m:w-[376px] mobile-l:ml-[-23px] tablet:ml-[-24px]   mobile-m:ml-[-25px] mobile-s:w-[315px] mobile-s:ml-[-20px]  z-[0] p-3   relative h-screen bg-[url(C:\Users\kadar\Mr.FullStack\MrFullStack-Frontend\src\assets\iPhone15ProMax.png)]  mx-auto  justify-center  bg-contain   bg-no-repeat my-auto  overflow-hidden">
        <img
          ...
          alt="iphoneicons"
        />
        <div className="relative shrink-0 z-50 gap-[200px] mobile-m:w-full mobile-m:h-[100px]  mobile-m:mt-[-120px] mobile-m:gap-[50px] mobile-l:gap-[30px]  tablet:gap-[100px] mobile-s:gap-[30px] w-full mt-[-300px] overflow-x-auto no-scrollbar flex justify-start items-center content-center">
