    ...
    return (
      <motion.div variants={fadeIn("up", "spring", index * 0.5, 0.75)}>
        <Tilt
          ...
          className="relative left-[20px] mobile-m:mt-[-415px] mobile-l:mt-[-390px]  mobile-s:mt-[-415px] mt-[-510px] object-contain flex-wrap  bg- rounded-2xl mobile-m:w-[200px] tablet:w-[200px] mobile-s:w-[50px] mobile-s:h-[50px] sm:w-[250px] sm:h-[250px]"
        >
          <div className="relative w-full mobile-s:p-1 mobile-m:p-1 mobile-s:w-[130px] mobile-m:w-[200px] mobile-l:w-[200px] mobile-l:h-[110px] tablet:w-[300px]  mobile-m:h-[110px] mobile-s:h-[100px] h-[280px]">
            ...
            <div className="mt-5 mobile-s:m-0  mobile-m:m-0 mobile-s:mt-[10px] mobile-m:mt-[-10px]  mobile-s:w-full">
              <h3 className="text-white font-bold mobile-s:text-[10px] mobile-m:mt-[20px] mobile-l:mt-[-18px]  mobile-m:text-[12px] mobile-l:text-[12px] tablet:mt-[-18px] tablet:text-[20px] text-[24px]">{name}</h3>
  ...
  return (
    <>
      <motion.div className="w-full mobile-s:mt-[-400px] mobile-m:mt-[-400px] mobile-l:mt-[-400px]">
        <p className={`${styles.sectionSubText} tablet:text-[30px] `}>Github Repo</p>
        <div className="inline-flex   justify-center items-center">
          <h2
            className={`${styles.sectionHeadText} tablet:text-[50px] mobile-m:text-[25px] mobile-l:text-[23px] mobile-m:p-1 mobile-s:text-[20.6px]  w-full mobile-s:p-3 p-5 inline-flex grid-flex-col pl-10 mx-auto`}
          >
            Enter Website
          </h2>
          <img
      ...
      <div className="iPad mobile-m:w-[115%] mobile-l:w-[425px] mobile-l:ml-[-25px] mobile-m:mt-[30px]  mobile-m:ml-[-25px] mobile-m:bg-contain mobile-s:w-[118%] mobile-s:ml-[-25px] mobile-s:mt-[20px] tablet:w-[768px] tablet:ml-[-26px] flex p-[5%] w-[105%]  gap-16 items-center no-scrollbar z-[0] relative h-screen bg-[url(C:\Users\kadar\Mr.FullStack\MrFullStack-Frontend\src\assets\iPad.png)]    justify-center  bg-contain bg-no-repeat   overflow-hidden">
        ...
        {projects.map((project, index) => (
          ...
          <img className=" absolute flex-wrap w-[90%] h-[1.5%] mobile-s:mt-[-279%] mobile-s:ml-[-14px]  mobile-s:w-[700px] mobile-s:p-10 mobile-s:h-fit mobile-m:mt-[-238%] mobile-l:mt-[-213%] tablet:ml-[-2px] tablet:mt-[-153%] tablet:h-fit tablet:w-[800px]  mobile-m:ml-[-14px] mobile-l:ml-[-16px]  mobile-m:w-[700px] mobile-l:w-[120%]  mobile-m:p-10 mobile-m:h-fit   mt-[-101%] p-[60px]  ml-[3%]" src={iPadStatusbar} alt="img" />
    </>
  );
};
