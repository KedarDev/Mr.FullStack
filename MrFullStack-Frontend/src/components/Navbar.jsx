...
const Navbar = () => {
  ...
  return (
    <nav
      className={`${styles.paddingX} sticky-top-0 w-full laptop-l:h-[60px] h-12 flex items-center py-0 fixed top-0 bg-white z-20`}
    >
      <div className="w-full flex justify-between items-center max-w-7x1">
        ...
        >
          <img
            ...
            src={darkflash}
            alt="darkflash"
            className=" laptop-l:w-[40px] laptop-l:h-[40px] laptop:ml-[10px] laptop:w-[40px] laptop:h-[40px] laptop-l:mt-[-3px] laptop:mt-[-8px] tablet:h-[28px] tablet:mt-[-3px] fixed w-6 h-6 top-3 left-0 object-cover flex justify-center items-center"
          />
          &nbsp;
          <span className="flex justify-center">
            <img
              ...
              src={mflogo}
              alt="mflogo"
              className=" laptop-l:ml-[-10px] laptop-l:w-[500px] laptop-l:h-[60px] laptop-l:mt-[2px] laptop:w-[500px] laptop:h-[50px] laptop:ml-[10px] laptop:mt-0.4 tablet:w-full tablet:h-[49px] tablet:ml-[180px] tablet:mt-[5m] mobile-m:w-[220px] mobile-m:ml-[34px] mobile-l:ml-[65px] mobile-l:w-[220px] mobile-m:mt-[2px] mobile-s:w-[200px] mobile-s:ml-[15px] w-full flex h-10 mx-auto justify-content justify-center items-center object-contain"
            />
          </span>
        </Link>
        <ul className=" list-none hidden sm:flex laptop:flex laptop-l:flex desktop:flex  flex-row gap-5">
          {navLink.map((Link) => (
            <li
              ...
              } hover:text-[#FF0000] laptop:text-[20px] laptop-l:text-[28px] text-[18px] font-medium cursor-pointer`}
          ...
          <a href="">
            <div className=" laptop-l:mt-[8px] laptop:mt-[3px] Button w-28 h-6 relative bottom-[3px] ">
