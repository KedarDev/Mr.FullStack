package com.resumeapp.mrfullstackbackend.exception;
...
import com.resumeapp.mrfullstackbackend.exception.domain.EmailNotFoundException;
...
@RestControllerAdvice // @ControllerAdvice annotation that marks a class as a global exception handler
